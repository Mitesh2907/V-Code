  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-t border-gray-800/50">
        ...
        className="w-full flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800/50 rounded-xl transition-colors">
          <Settings size={20} />
          <AnimatePresence>
            {!collapsed && (
              <motion.span
        ...
        className="w-full flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-xl transition-colors mt-1">
          <LogOut size={20} />
          <AnimatePresence>
            {!collapsed && (
              <motion.span
